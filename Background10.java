...
public class Background10 extends JPanel{
		...
		public void paint(Graphics g) {
			...
			g.drawImage(tile[11], 2 * l + xOffset, 3 * l + yOffset, l, l, null);
			g.drawImage(tile[10], 3 * l + xOffset, 3 * l + yOffset, l, l, null);
...
//		  Background10 p = new Background10();
//		  f.setSize(1300,980);
//		  f.setVisible(true);
